...
exec_pruning_factor=(0.1 0.5 0.7 1)
exec_n_threads=(1)
...
for n_threads in "${exec_n_threads[@]}"; do
	echo MODELS: $exec_n_models NLETTERS: $n_letters MAXHEIGHT: $max_formula_height NFORMULAS: $n_formulas PRFACTOR: $pruning_factor REPS: $repetitions
